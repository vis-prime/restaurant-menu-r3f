        ...
        <div className=" flex md:grid md:grid-cols-1 gap-2 md:gap-4 overflow-x-auto md:overflow-x-visible overflow-y-hidden md:overflow-y-visible pb-2 md:pb-0 h-full md:h-auto">
          {MenuItems.map((item, index) => (
            <motion.div
              ...
              key={item.id}
              className={`m-1 group bg-white rounded-xl md:rounded-2xl shadow-md transition-all duration-300 p-3 md:p-6 flex flex-col cursor-pointer border border-gray-100 hover:border-emerald-200 transform flex-shrink-0 w-40 md:w-auto ${
